...
//		$msg ="Sorry Invalid credentials please try again.";
        $msg =  "Sorry!!! Invalid Email or Captured image please try again.";
	...
	<head>
		...
		$(function(){
			...
			function validateForm() {
				var formEmail = document.forms["login"]["email"].value;
				var atpos = formEmail.indexOf("@");
				var dotpos = formEmail.lastIndexOf(".");
				if (atpos<1 || dotpos<atpos+2 || dotpos+2>=formEmail.length) {
